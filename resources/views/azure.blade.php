            ...
            <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                    <div data-anim="slide-up delay-1">
                        ...
                        <h1 class="page-masthead__title text-white">Azure</h1>
                    </div>
                </div>
                ...
                <div class="col-auto">
                    <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                        ...
                        /
                        <a data-barba href="#" class="page-masthead-bread__item">Azure</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="gallery row x-gap-10 y-gap-10 pr-80 lg:pr-0">
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/658.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/658.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/0574.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/0574.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/0619.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/0619.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/11.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/11.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/12.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/12.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/19.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/19.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/22.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/22.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/24.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/24.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/25.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/25.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/1.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/1.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/2.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/2.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/cards/3.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/cards/3.jpg" alt="project image" />
                                </div>
                ...
                <div class="col-lg-4 col-md-10">
                    <div class="text-left js-pin-content">
                        <h3 class="text-4xl leading-2xl md:mt-48">Beach Front Villas</h3>
                        <p class="mt-12">A few steps away from the Mediterranean's crystal blue waters, Azure is a gated complex of 16 modern home, immersed in beautiful greenery.</p>
                        ...
                        <div class="row y-gap-32 pt-32">
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Private Villas</div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">NUMBER OF UNITS</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> 16</div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">STATUS</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Completed</div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span>
                                    ...
                                    - Private Roof Garden <br>
                                    - 300 sqm of Garden <br>
                                    - Unblocable Sea Views
                                </div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">INVESTMENT GROUP</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Kybana Group LTD</div>
                            </div>
                        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a data-barba href="{{ route('bluhorizon_path') }}" class="portfolioCard -type-1 ratio">
                            <div class="portfolioCard__image ratio ratio-3:4">
                                <img class="ratio-img js-lazy" src="#" data-src="/img/portfolio/fancy/bluhorizon.jpg" alt="Blu Horizon" />
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="{{route('azure_path')}}" id="projectform" method="POST">
                    @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="{{route('azure_inquire_path')}}" id="inquireform" method="POST">
                    @csrf
                    <div class="col-12 mt-20">
                        <div class="js-input-group">
                            <input type="text" name="name" required placeholder="Your Name" />
