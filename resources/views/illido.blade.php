            ...
            <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                    <div data-anim="slide-up delay-1">
                        ...
                        <h1 class="page-masthead__title text-white">Il Lido</h1>
                    </div>
                </div>
                ...
                <div class="col-auto">
                    <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                        ...
                        /
                        <a data-barba href="#" class="page-masthead-bread__item">Il Lido</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="gallery row x-gap-10 y-gap-10 pr-80 lg:pr-0">
                        <div class="col-6">
                            <a href="/img/portfolio/illido/1.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/illido/1.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/illido/2.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/illido/2.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/illido/3.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/illido/3.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/illido/4.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/illido/4.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/illido/5.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/illido/5.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/illido/6.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/illido/6.jpg" alt="project image" />
                                </div>
                ...
                <div class="col-lg-4 col-md-10">
                    <div class="text-left js-pin-content">
                        <h3 class="text-4xl leading-2xl md:mt-48">Exclusive</h3>
                        <p class="mt-12">Located in one of the island’s most exquisite spot, Il Lido is only a few steps away from a hidden creek, a glorious masterpiece by mother nature.</p>
                        ...
                        <div class="row y-gap-32 pt-32">
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> 6</div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> May 2023</div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">INVESTEMENT GROUP</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Cartle LTD.</div>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-md-auto col-6">
                <a data-barba href="{{ route('azure_path') }}" class="related-nav__item -prev">
            ...
            <div class="col-md-auto col-6">
                <a data-barba href="{{ route('bluhorizon_path') }}" class="related-nav__item -next">
                    <div class="related-nav__content">
                        <span>NEXT</span>
                        <p>Blu Horizon</p>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="{{route('illido_path')}}" id="projectform" method="POST">
                    @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="{{route('illido_inquire_path')}}" id="inquireform" method="POST">
                    @csrf
                    <div class="col-12 mt-20">
                        <div class="js-input-group">
                            <input type="text" name="name" required placeholder="Your Name" />
