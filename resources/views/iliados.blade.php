            ...
            <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                    <div data-anim="slide-up delay-1">
                        ...
                        <h1 class="page-masthead__title text-white">Iliados 3</h1>
                    </div>
                </div>
                ...
                <div class="col-auto">
                    <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                        ...
                        /
                        <a data-barba href="#" class="page-masthead-bread__item">Iliados 3</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="gallery row x-gap-10 y-gap-10 pr-80 lg:pr-0">
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/iliados/1.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/iliados/1.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/iliados/2.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/iliados/2.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/iliados/3.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/iliados/3.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/iliados/4.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/iliados/4.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/iliados/5.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/iliados/5.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/iliados/6.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/iliados/6.jpg" alt="project image" />
                                </div>
                ...
                <div class="col-lg-4 col-md-10">
                    <div class="text-left js-pin-content">
                        ...
                        <p class="mt-12">
                            ...
                            Pangrati is the most in-demand area of Central Athens. It is a favorite amongst locals and tourists for trendy restaurants, boutiques, and galleries.<br>
                        ...
                        <div class="row y-gap-32 pt-32">
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Pangrati, Athens</div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">TYPE</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Renovated Apartment</div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">FLOOR</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> 4</div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> 73</div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="{{route('iliados_inquire_path')}}" id="inquireform" method="POST">
                    @csrf
                    <div class="col-12 mt-20">
                        <div class="js-input-group">
                            <input type="text" name="name" required placeholder="Your Name" />
