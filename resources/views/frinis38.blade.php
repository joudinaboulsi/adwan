            ...
            <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                    <div data-anim="slide-up delay-1">
                        ...
                        <h1 class="page-masthead__title text-white">Frinis 38</h1>
                    </div>
                </div>
                ...
                <div class="col-auto">
                    <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                        ...
                        /
                        <a data-barba href="#" class="page-masthead-bread__item">Frinis 38</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="gallery row x-gap-10 y-gap-10 pr-80 lg:pr-0">
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/Frinis 38/Dining.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/Frinis 38/Dining.jpg')}}" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/Frinis 38/Bedroom 1.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/Frinis 38/Bedroom 1.jpg')}}" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/Frinis 38/Bedroom 2.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/Frinis 38/Bedroom 2.jpg')}}" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/Frinis 38/Kitchwn.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/Frinis 38/Kitchwn.jpg')}}" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/Frinis 38/Bathroom B.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/Frinis 38/Bathroom B.jpg')}}" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/Frinis 38/Living 2.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/Frinis 38/Living 2.jpg')}}" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                                <a href="{{asset('img/Frinis 38/Living 3.jpg')}}" class="gallery__item js-gallery" data-gallery="gallery1">
                                    <div class="ratio ratio-1:1">
                                        <img class="ratio-img" src="{{asset('img/Frinis 38/Living 3.jpg')}}" alt="project image" />
                                    </div>
                    ...
                    <div class="text-left js-pin-content">
                        ...
                        <div class="row y-gap-32 pt-32">
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> 1st</div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> 70</div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> 1</div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="{{route('frinis_inquire_path')}}" id="inquireform" method="POST">
                    @csrf
                    <div class="col-12 mt-20">
                        <div class="js-input-group">
                            <input type="text" name="name" required placeholder="Your Name" />
