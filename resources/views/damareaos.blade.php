            ...
            <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                    <div data-anim="slide-up delay-1">
                        ...
                        <h1 class="page-masthead__title text-white"> Damareos 59</h1>
                    </div>
                </div>
                ...
                <div class="col-auto">
                    <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                        ...
                        /
                        <a data-barba href="#" class="page-masthead-bread__item"> Damareos 59</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="gallery row x-gap-10 y-gap-10 pr-80 lg:pr-0">
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/damareos/01_Elevation.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/damareos/01_Elevation.jpg')}}" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/damareos/02_AxoElevation.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/damareos/02_AxoElevation.jpg')}}" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/damareos/03_Entrance.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/damareos/03_Entrance.jpg')}}" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="{{asset('img/damareos/04_Upper Floors.jpg')}}" class="gallery__item js-gallery"
                                data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="{{asset('img/damareos/04_Upper Floors.jpg')}}" alt="project image" />
                                </div>
                ...
                <div class="col-lg-4 col-md-10">
                    <div class="text-left js-pin-content">
                        <h3 class="text-4xl leading-2xl md:mt-48">In the heart of Athens</h3>
                        <p class="mt-12">Luxurious 10-floor building in Pangrati, Athens Center, with stunning Accropolis Views.</p>

                        <div class="row y-gap-32 pt-32">
                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">LOCATION</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Athens, Greece
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> 12</div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">STATUS</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Under Development
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> November 2025</div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">INVESTMENT GROUP</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span>RM2 Development
                                     LTD
                                  </div>
                            </div>
                        </div>
                        ...
                        <div class="row y-gap-20 pt-20">
                            <div class="col-12">
                                <a data-barba href="" data-toggle="modal" data-target="#brochureModal"
                                    class="button -md -dark text-white mb-2">DOWNLOAD BROCHURE</a>
                    ...
                    <div class="swiper-slide">
                        <a data-barba href="{{ route('azure_path') }}" class="portfolioCard -type-1 ratio">
                            <div class="portfolioCard__image ratio ratio-3:4">
                                <img class="ratio-img js-lazy" src="#" data-src="/img/portfolio/fancy/azure.jpg"
                                    alt="Azure" />
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="{{route('damareos_path')}}" id="projectform" method="POST">
                    @csrf
