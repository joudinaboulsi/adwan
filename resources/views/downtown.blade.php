            ...
            <div class="row justify-content-between md:justify-content-center align-items-center">
                <div class="col-lg-9 col-md-10">
                    <div data-anim="slide-up delay-1">
                        ...
                        <h1 class="page-masthead__title text-white">Down Town Views</h1>
                    </div>
                </div>
                ...
                <div class="col-auto">
                    <div data-anim="slide-up delay-1" class="page-masthead-bread text-white md:mt-24">
                        ...
                        /
                        <a data-barba href="#" class="page-masthead-bread__item">Down Town Views</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="gallery row x-gap-10 y-gap-10 pr-80 lg:pr-0">
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/downtown/6.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/downtown/6.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/downtown/7.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/downtown/7.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/downtown/8.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/downtown/8.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/downtown/1.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/downtown/1.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/downtown/2.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/downtown/2.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/downtown/3.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/downtown/3.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/downtown/4.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/downtown/4.jpg" alt="project image" />
                                </div>
                        ...
                        <div class="col-6">
                            <a href="/img/portfolio/downtown/5.jpg" class="gallery__item js-gallery" data-gallery="gallery1">
                                <div class="ratio ratio-1:1">
                                    <img class="ratio-img" src="/img/portfolio/downtown/5.jpg" alt="project image" />
                                </div>
                ...
                <div class="col-lg-4 col-md-10">
                    <div class="text-left js-pin-content">
                        <h3 class="text-4xl leading-2xl md:mt-48">Contemporary Living in the heart of Nicosia</h3>
                        <p class="mt-12">Located in Lykavitos, the heart of Nicosia, yet in a green & tranquil neighborhood, our newest project is perfectly nested on a hill, gifting us gorgeous open views of the capital.</p>

                        <div class="row y-gap-32 pt-32">
                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">LOCATION</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Nicosia, Cyprus</div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> 14</div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">STATUS</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Under Development</div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span>
                                    - Open views on the center of Nicosia<br>
                            ...
                            <div class="col-lg-6 col-md-4 col-6">
                                ...
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> May 2025</div>
                            </div>

                            <div class="col-lg-6 col-md-4 col-6">
                                <div class="text-sm leading-md uppercase text-black fw-600">INVESTMENT GROUP</div>
                                <div class="text-sm details-text fw-600"><span class="text-lg"></span> Investors Group Ltd</div>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-md-auto col-6">
                <a data-barba href="{{ route('bluhorizon_path') }}" class="related-nav__item -prev">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="{{route('downtown_path')}}" id="projectform" method="POST">
                    @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row" action="{{route('downtown_inquire_path')}}" id="inquireform" method="POST">
                    @csrf
                    <div class="col-12 mt-20">
                        <div class="js-input-group">
                            <input type="text" name="name" required placeholder="Your Name" />
